...
## Session counter
Current session: 7
Last log: /Users/uros/Documents/Private/Projects/PerunApp/.claude/agents/tmnt/session-logs/2026-06-28-S7-donatello.md
...
- P1 (S7): Port shared data layer into web/ app — DONE
...
- P1: Ported 9 files to web/ (types, constants, admin services, booking errors). All source files are pure TS (no React Native / Expo deps). Three supabase imports replaced with `@/lib/supabase`. bookingErrors.ts extracted __DEV__ → import.meta.env.DEV. Assets cleanup removed vite template cruft. Build + lint both pass.
